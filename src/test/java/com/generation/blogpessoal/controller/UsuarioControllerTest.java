...
public class UsuarioControllerTest {
    ...
    public void deveCriarUmUsuario() {
        HttpEntity<Usuario> corpoRequisicao = new HttpEntity<>(new Usuario(0L, "Paulo Antunes", "paulo_antunes@email.com.br", "13465278", "-"));
    ...
    public void naoDeveDuplicarUsuario() {
        ...
        HttpEntity<Usuario> corpoRequisicao = new HttpEntity<>(new Usuario(0L, "Maria da Silva", "maria_silva@email.com.br", "13465278", "-"));
        ResponseEntity<Usuario> corpoResposta = testRestTemplate.exchange("/usuarios/cadastrar", HttpMethod.POST, corpoRequisicao, Usuario.class);
    ...
    public void deveAtualizarUmUsuario() {
        Optional<Usuario> usuarioCadastrado = usuarioService.cadastrarUsuario(new Usuario(0L,
                "Jualiana Andrews", "juliana_andrews@email.com.br", "juliana123", "-"));
